...
{
    class NoSellingObjectsConsecratedToGod : TreatAsHolyEverythingConsecratedToGod
    {
        public NoSellingObjectsConsecratedToGod()
        {
            ...
            base.Number = 232;
            base.ShortSummary = "No selling anything consecrated to God.";

class app {
    ...
    createTree() {
        ...
        var margin = { top: 50, right: 120, bottom: 20, left: 1250 },
    ...
    createHoverTips() {
        ...
        $(".mitzvah").popover({
            ...
            title: function() { 
                var node: Node = this;
                var mitzvotNumber: number = parseInt(node.attributes['data-mitzvot-number'].value, 10);
    ...
    findCommandmentByNumber(commandmentNumber: number): CommandmentBase {
        var nodesToCheck: CommandmentBase[] = [this.root];
    ...
    update(source) {
        ...
        var nodeEnter = node.enter()
            ...
            .attr("data-mitzvot-number", (c: CommandmentBase) => c.number)
        ...
        nodeEnter.append("text")
            ...
            .text((d: CommandmentBase) => d.shortSummary)
            .style("fill-oopacity", 1)
